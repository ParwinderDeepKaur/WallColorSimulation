...
namespace ColorSet
{
    public class Startup
    {
        ...
        {
            services.AddEntityFrameworkSqlite().AddDbContext<SetColorLibrary.Data.ApplicationDbContext>();
            services.AddDatabaseDeveloperPageExceptionFilter();
            services.AddDefaultIdentity<IdentityUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddEntityFrameworkStores<SetColorLibrary.Data.ApplicationDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ColorSet v1"));
            }
            else
            {
